...
const WithdrawMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .put(
        `http://localhost:3500/api/v2/shop/update-payment-methods`,
        {
          withdrawMethod,
        },
  ...
  const deleteHandler = async () => {
    await axios
      .delete(`http://localhost:3500/api/v2/shop/delete-withdraw-method`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const withdrawHandler = async () => {
    if (withdrawAmount < 50 || withdrawAmount > availableBalance) {
      ...
      await axios
        .post(
          `http://localhost:3500/api/v2/withdraw/create-withdraw-request`,
          { amount },
          { withCredentials: true }
        )
        .then((res) => {
